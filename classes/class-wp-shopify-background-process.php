...
if ( ! class_exists( 'WP_Shopify_Background_Process' ) ) {

	/**
	 * Abstract WP_Shopify_Background_Process class.
	 *
	 * @abstract
	 * @extends WP_Async_Request
	 */
	abstract class WP_Shopify_Background_Process extends \WPS\WP_Shopify_Async_Request {
