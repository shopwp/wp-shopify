...
if (!class_exists('Settings_Syncing')) {
  ...
  class Settings_Syncing extends \WPS\DB {
    ...
    public $table_name;
  	...
  	public $primary_key;
		...
		public $syncing_totals_shop;
		public $syncing_totals_smart_collections;
		public $syncing_totals_custom_collections;
		public $syncing_totals_products;
		public $syncing_totals_collects;
		public $syncing_totals_orders;
		public $syncing_totals_customers;
		public $syncing_totals_webhooks;
		public $syncing_current_amounts_shop;
		public $syncing_current_amounts_smart_collections;
		public $syncing_current_amounts_custom_collections;
		public $syncing_current_amounts_products;
		public $syncing_current_amounts_collects;
		public $syncing_current_amounts_orders;
		public $syncing_current_amounts_customers;
		public $syncing_current_amounts_webhooks;
		public $syncing_start_time;
		public $syncing_end_time;
		public $syncing_errors;
		public $syncing_warnings;
		public $finished_webhooks_deletions;
		public $finished_product_posts_relationships;
		public $finished_collection_posts_relationships;
		public $finished_data_deletions;
      ...
      $this->cache_group     															= 'wps_db_syncing';
			...
			$this->syncing_step_total 													= 0;
			$this->syncing_step_current 												= 0;

			$this->syncing_totals_shop 													= 1;
			$this->syncing_totals_smart_collections 						= 0;
			$this->syncing_totals_custom_collections 						= 0;
			$this->syncing_totals_products 											= 0;
			$this->syncing_totals_collects 											= 0;
			$this->syncing_totals_orders 												= 0;
			$this->syncing_totals_customers 										= 0;
			$this->syncing_totals_webhooks 											= 0;

			$this->syncing_current_amounts_shop 								= 0;
			$this->syncing_current_amounts_smart_collections 		= 0;
			$this->syncing_current_amounts_custom_collections 	= 0;
			$this->syncing_current_amounts_products 						= 0;
			$this->syncing_current_amounts_collects 						= 0;
			$this->syncing_current_amounts_orders 							= 0;
			$this->syncing_current_amounts_customers 						= 0;
			$this->syncing_current_amounts_webhooks 						= 0;

			$this->syncing_start_time 													= 0;
			$this->syncing_end_time 														= 0;
			$this->syncing_errors 															= null;
			$this->syncing_warnings 														= null;

			$this->finished_webhooks_deletions 									= 0;
			$this->finished_product_posts_relationships 				= 0;
      ...
      return [
        ...
        'is_syncing'                										=> $this->is_syncing,
				'syncing_totals_shop'														=> $this->syncing_totals_shop,
				'syncing_totals_smart_collections'							=> $this->syncing_totals_smart_collections,
				'syncing_totals_custom_collections'							=> $this->syncing_totals_custom_collections,
				'syncing_totals_products'												=> $this->syncing_totals_products,
				'syncing_totals_collects'												=> $this->syncing_totals_collects,
				'syncing_totals_orders'													=> $this->syncing_totals_orders,
				'syncing_totals_customers'											=> $this->syncing_totals_customers,
				'syncing_totals_webhooks'												=> $this->syncing_totals_webhooks,
				'syncing_step_total'														=> $this->syncing_step_total,
				'syncing_step_current'													=> $this->syncing_step_current,
				'syncing_current_amounts_shop'									=> $this->syncing_current_amounts_shop,
				'syncing_current_amounts_smart_collections'			=> $this->syncing_current_amounts_smart_collections,
				'syncing_current_amounts_custom_collections'		=> $this->syncing_current_amounts_custom_collections,
				'syncing_current_amounts_products'							=> $this->syncing_current_amounts_products,
				'syncing_current_amounts_collects'							=> $this->syncing_current_amounts_collects,
				'syncing_current_amounts_orders'								=> $this->syncing_current_amounts_orders,
				'syncing_current_amounts_customers'							=> $this->syncing_current_amounts_customers,
				'syncing_current_amounts_webhooks'							=> $this->syncing_current_amounts_webhooks,
				'syncing_start_time'														=> $this->syncing_start_time,
				'syncing_end_time'															=> $this->syncing_end_time,
				'syncing_errors'																=> $this->syncing_errors,
				'syncing_warnings'															=> $this->syncing_warnings,
    ...
    public function create_table_query($table_name = false) {
      ...
      return "CREATE TABLE $table_name (
        ...
        is_syncing tinyint(1) DEFAULT 0,
				...
				syncing_errors LONGTEXT,
				syncing_warnings LONGTEXT,
