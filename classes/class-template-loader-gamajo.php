 ...
 *
 * @package   WPS_Gamajo_Template_Loader
 * @author    Gary Jones
...
if ( ! class_exists( 'WPS_Gamajo_Template_Loader' ) ) {
	 ...
	 *
	 * When using in a plugin, create a new class WPS_that extends this one and just overrides the properties.
	 *
	 * @package WPS_Gamajo_Template_Loader
	 * @author  Gary Jones
	 */
	class WPS_Gamajo_Template_Loader {
		/**
		 ...
		 *                         Default is 'data'.
		 *
		 * @return WPS_Gamajo_Template_Loader
		 */
