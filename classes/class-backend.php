			...
			wp_localize_script(
				...
				[
					...
					'settings'									=> [
						...
						'pricingLocalCurrencyToggle'				=> $this->DB_Settings_General->get_col_value('pricing_local_currency_toggle', 'string'),
						'pricingLocalCurrencyWithBase'				=> $this->DB_Settings_General->get_col_value('pricing_local_currency_with_base', 'string'),
