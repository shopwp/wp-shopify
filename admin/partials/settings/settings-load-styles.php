      ...
      <tr valign="top">
        ...
        <td class="forminp forminp-text">
          ...
          <label for="<?php echo $this->config->settings_general_option_name; ?>_styles_core" class="wps-label-block">
            <input name="<?php echo $this->config->settings_general_option_name; ?>[wps_general_styles_core]" id="<?php echo $this->config->settings_general_option_name; ?>_styles_core" type="checkbox" <?php echo $general->styles_core ? 'checked' : ''; ?> <?php echo $general->styles_all ? 'disabled' : ''; ?>> <?php printf(__('Core styles <small>(cart, hide/show classes, etc)</small>', 'wp-shopify')); ?>
          </label>

          <label for="<?php echo $this->config->settings_general_option_name; ?>_styles_grid" class="wps-label-block">
            <input name="<?php echo $this->config->settings_general_option_name; ?>[wps_general_styles_grid]" id="<?php echo $this->config->settings_general_option_name; ?>_styles_grid" type="checkbox" <?php echo $general->styles_grid ? 'checked' : ''; ?> <?php echo $general->styles_all ? 'disabled' : ''; ?>> <?php esc_html_e( 'Grid styles', 'wp-shopify' ); ?>
          </label>
        </td>
