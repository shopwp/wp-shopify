    ...
    <tbody>
      <tr valign="top">
        <th scope="row" class="titledesc">
          ...
          <span class="wps-help-tip" title="<?php esc_attr_e( 'Needs to be publicly accesible. Change to a proxy URL during local development using something like ngrok', 'wp-shopify' ); ?>"></span>
        </th>
