        ...
        <table class="form-table">
          <tbody>
            <tr valign="top">
              ...
              <th scope="row" class="titledesc">
                <?php esc_attr_e( 'Load cart', 'wp_admin_style' ); ?>
              </th>
        ...
        <table class="form-table">
          <tbody>
            <tr valign="top">
              ...
              <th scope="row" class="titledesc">
                <?php esc_attr_e( 'Price formatting', 'wp_admin_style' ); ?>
              </th>

              <td class="forminp forminp-text">
                <label for="<?php echo $this->config->settings_general_option_name; ?>_price_with_currency" class="wps-label-block">
                  <input name="<?php echo $this->config->settings_general_option_name; ?>[wps_general_price_with_currency]" id="<?php echo $this->config->settings_general_option_name; ?>_price_with_currency" type="checkbox" <?php echo $general->price_with_currency ? 'checked' : ''; ?>> Show currency symbol with price
                </label>
              </td>
